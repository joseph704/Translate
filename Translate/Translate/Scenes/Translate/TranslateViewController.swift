...
private extension TranslateViewController {
    func setupViews() {
        ...
        let defaultSpcaing: CGFloat = 16.0
        
        buttonStackView.snp.makeConstraints {
            $0.top.equalTo(view.safeAreaLayoutGuide)
            $0.leading.equalToSuperview().inset(defaultSpcaing)
            $0.trailing.equalToSuperview().inset(defaultSpcaing)
        ...
        resultBaseView.snp.makeConstraints {
            ...
            $0.top.equalTo(buttonStackView.snp.bottom).offset(defaultSpcaing)
            $0.bottom.equalTo(bookmarkButton.snp.bottom).offset(defaultSpcaing)
        }
        ...
        sourceLabelBaseButton.snp.makeConstraints {
            $0.leading.equalToSuperview()
            $0.trailing.equalToSuperview()
            $0.top.equalTo(resultBaseView.snp.bottom).offset(defaultSpcaing)
